...
const u8 gOtherText_Track1[] = _("TRACK 1");
const u8 gOtherText_Track2[] = _("TRACK 2");
const u8 gOtherText_Track3[] = _("TRACK 3");
const u8 gOtherText_Track4[] = _("TRACK 4");
...
const u8 gText_PlayerScurriedBackHome[] = _("{PLAYER} frantically scurried over\nto {RIVAL}'s house, since MOM\nwas out shopping...\p");
