...
const u16 gMetatiles_viridianpalette[] = INCBIN_U16("data/tilesets/secondary/viridianpalette/metatiles.bin");
const u32 gMetatileAttributes_viridianpalette[] = INCBIN_U32("data/tilesets/secondary/viridianpalette/metatile_attributes.bin");
